...
_G.packer_plugins = {
  ["everforest-nvim"] = {
    loaded = true,
    path = "/home/luca/.local/share/nvim/site/pack/packer/start/everforest-nvim",
  ...
  neogit = {
    loaded = true,
    path = "/home/luca/.local/share/nvim/site/pack/packer/start/neogit",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/luca/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
